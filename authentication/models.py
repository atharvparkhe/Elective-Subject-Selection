...
class StudentModel(BaseUser):
    ...
    department = models.ForeignKey(DepartmentModel, related_name="student_department", on_delete=models.CASCADE, null=True, blank=True)
    def __str__(self):
        return self.name
...
class TeacherModel(BaseUser):
    ...
    profile_pic = models.ImageField(upload_to="teacher", height_field=None, width_field=None, max_length=None)
