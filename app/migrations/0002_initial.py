...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='final_decision',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_3_decision', to='app.statusmodel'),
        ),
        migrations.AddField(
            model_name='changeelectivemodel',
            name='from_sub',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_1_decision', to='app.statusmodel'),
        ),
        migrations.AddField(
            model_name='changeelectivemodel',
            name='teacher_2_decision',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_2_decision', to='app.statusmodel'),
        ),
        migrations.AddField(
            model_name='changeelectivemodel',
            name='to_sub',
